...
import 'package:flutter_ui_challenges/challenges/challenge_four.dart';
...
final List<Challenge> registry = [
  ...
  Challenge(title: 'Challenge Four', category: '100 Days', builder: (_) => const ChallengeFour(), description: ''),
];
